...
\usepackage{charter}                %Heavier font
...
\usepackage[charter]{mathdesign}    %Set math font to charter (same as serif document font)
\usepackage{microtype}              %Use larger letterspacing with lsstyle, requires mathdesign.sty (debian package texlive-fonts-extra)
