...
Add TODOs for example like this \todonum{A todo!}. \blindtext
...
To directly include the PDF of a paper (for cumulative theses) use \mintinline[breaklines,breakanywhere]{tex}{\includepdf[pages=-]{paper.pdf}}

\subsection{PGF plots}
Use matplotlib's PGF backend to create natively rendering plots such as \Cref{fig:sequencingcost}. Make sure to setup the preamble in line with the document.
...
\begin{figure}[t]
	\begin{center}
		\resizebox{0.55\linewidth}{!}{\input{./sequencingCost.pgf}}
	\end{center}
	\caption[\figintro{Decline in sequencing costs}]{\figintro{Decline in sequencing costs.}}
